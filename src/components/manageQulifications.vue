...
<div class="">
    ...
    <v-dialog v-model="dialogDelete" max-width="500px">
        <v-card>
            ...
            <v-card-title class="text-h5"><i class="label1_text mt-4">Are you sure you want to delete</i> "{{deleteName}}"</v-card-title>
            <v-card-actions>
                <v-spacer></v-spacer>
    ...
    <v-dialog v-model="dialogEdit" width="600" persistent>
        <v-card class="text-center" style="text-align: center">
            <div style="background-color: #f2f9ff; color: #17517e">
                <v-row>
                    <v-col class="text-h6 text-center pa-4" cols="8">Qualificaton</v-col>
                    <v-col cols="2">
                        <v-btn text style="color: green; font-size: 12px; font-weight: 600"><img @click="dialogEdit=false" src="../../public/cancel.svg" alt=""></v-btn>
                    </v-col>
                </v-row>
            ...
            <div class="px-8 pt-3 pb-12">
                ...
                <v-form>
                    <v-text-field v-model="editQualificationName" label="Qualification Name" outlined></v-text-field>
                    <v-select v-model="editQualificationType" :items="qualificationTypeSelect" label="Qualification type" outlined></v-select>
                    <v-btn block color="#17517E" style="color: #fff" class="pa-6" @click="createManageQualification">
                        Submit
                    </v-btn>
                </v-form>
            </div>
    ...
    <v-dialog v-model="dialog2" width="400">
        <v-card class="text-center" style="text-align: center">
            ...
            <div class="px-8 pt-3 pb-12">
                ...
                <v-form>
                    <v-text-field v-model="qualificationName" label="Qualification Name" outlined></v-text-field>
                    <v-select v-model="qualificationType" :items="qualificationTypeSelect" label="Qualification type" outlined></v-select>
                    <v-btn block color="#17517E" style="color: #fff" class="pa-6" @click="createManageQualification">
                        Submit
                    </v-btn>
                </v-form>
