<template>
<div class="">
    <h4 style="font-weight: bolder" class="pa-5">Allowance Exclusion</h4>
    <v-card>
        <v-row>
            <v-col cols="12">
                <div class="_header px-10 pt-5">
                    <h4 style="font-size: 18px">
                        Allownace Exclusion - Approved List
                    </h4>
                    <div>
        ...
        <v-card class="text-center" style="text-align: center">
            ...
            <div class="px-8 pt-3 pb-12">
                <v-card-text style="font-size: 16px; font-weight: bolder" class="mb-3" densed>
                    Add  Allowance Exclusion                </v-card-text>
                <v-form>
    ...
    methods: {
        ...
        async populateUnitAllowance() {
            const res = await axios({
                ...
                method: "get",
                url: `${this.baseURL}/allowance_exclusion?institution_code=${this.instu_code}`,
            });
            console.log('Result For Allowance Exclusion', res);
            res.data.response.message.data.forEach((el) => {
                ...
                this.items.push({
                    ...
                    allowance_exclusion_code: el.allowance_exclusion_code,
        ...
        async finalCreationCreateUnitAllowance(category) {
            ...
            try {
                const res = await axios({
                    ...
                    method: "post",
                    url: `${this.baseURL}/allowance_exclusion`,
                    data: {
                        institution_code: this.instu_code,
                ...
                const message = res.data.response.message.message;
                if (res.data.response.code === "00") {
                    console.log("Allowance Exclusion", res);
                    ...
                    this.items.push({
                        ...
                        allowance_exclusion_code: data.allowance_exclusion_code,
                    });
        ...
        createUnitAllowance() {
            ...
            if (this.salary_scale_regime == "" || this.allowance_name == "" ||
                this.applicationCode == "") {
